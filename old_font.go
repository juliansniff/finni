...
//
// 	advance, err := f.font.GlyphAdvance(&b, x, ppem, font.HintingNone)
// 	if err != nil {
// 		return character, fmt.Errorf("could not get glyph advance: %v", err)
// 	}
// 	metrics, err := f.font.Metrics(&b, ppem, font.HintingNone)
// 	if err != nil {
// 		return character, fmt.Errorf("could not get glyph metrics: %v", err)
// 	}
//
// 	var xpos, ypos, h, w float32
// 	xpos = 0
// 	ypos = 0 - float32(metrics.Descent)/64
// 	h = float32(metrics.Height) / 64
